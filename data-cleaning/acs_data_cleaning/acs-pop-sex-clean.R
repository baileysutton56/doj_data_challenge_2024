...
# Read 2020 data
pop_2020 <- read_excel('/3. Import Data/Census ACS/2020/population-by-sex-2020.xlsx', sheet='Sheet1')
...
Population <- read.csv('/3. Import Data/Census ACS/Population.csv')
Sex <- read.csv('/3. Import Data/Census ACS/Sex Total.csv')
...
# Export CSV
write.csv(pop_sex_clean_all, '/3. Import Data/Census ACS/Final-Cleaned/population_sex.csv')
